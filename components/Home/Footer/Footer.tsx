    ...
    return (
        <div className='pt-16 pb-16'>
            <div className='w-[80%] mx-auto items-start grid-cols-1 sm:grid-cols-2 grid md:grid-cols-2 lg:grid-cols-4  gap-10 '>
                ...
                {/* 3rd part */}
                <div className='space-y-5'>
                    <h1 className='text-lg font-bold'>Aadhar Services</h1>
                ...
                <div className='space-y-5'>
                    ...
                    <div className='mt-6'>
                        ...
                        <h1 className='text-base font-bold text-blue-950 mt-1'>+012 345 678</h1>
                    </div>
                    <div className='mt-6'>
                        <h1 className='text-sm text-gray-600'>Our Email Address</h1>
                        <h1 className='text-base font-bold text-blue-950 mt-1'>travella123@gmail.com</h1>
                    </div>
                </div>
            </div>
            {/* BottomSection */}
            <div className='mx-auto border-t mt-8 w-[80%] pt-8 flex flex-col md:flex-row justify-between items-center text-gray-600 text-sm '>
